...
from insomnia import start_insomnia;
...
accept = pyautogui.confirm(text=alert, title="Auto boot Development System", buttons=['OK', 'Cancelar', 'Abrir Insomnia'])
